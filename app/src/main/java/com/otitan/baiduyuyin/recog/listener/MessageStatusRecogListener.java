package com.otitan.baiduyuyin.recog.listener;
...
//        sendStatusMessage(SpeechConstant.CALLBACK_EVENT_WAKEUP_READY, "引擎就绪，可以开始说话。");
        sendStatusMessage(SpeechConstant.CALLBACK_EVENT_WAKEUP_READY, "请开始说话");
    }
...
//        sendStatusMessage(SpeechConstant.CALLBACK_EVENT_ASR_BEGIN, "检测到用户说话");
        sendStatusMessage(SpeechConstant.CALLBACK_EVENT_ASR_BEGIN, "正在聆听...");
    }
...
//        sendStatusMessage(SpeechConstant.CALLBACK_EVENT_ASR_FINISH, "正在识别...");
...
//        sendStatusMessage(SpeechConstant.CALLBACK_EVENT_ASR_EXIT, "识别引擎结束并空闲中");
        sendStatusMessage(SpeechConstant.CALLBACK_EVENT_ASR_EXIT, "停止识别");
    }
