...
class LdzzDataViewModel() : BaseViewModel() {

    var data: ResultModel<LdzzModel<LdzzModel.Sjgl>>? = null
    //请求返回列表数据集合
...
//                        dismissDialog()
                    ...
                    override fun onSuccess(result: Any) {
                        dismissDialog()
                        data = result as ResultModel<LdzzModel<LdzzModel.Sjgl>>
                        when (requestCode) {
                            1 -> {
                                items.clear()
