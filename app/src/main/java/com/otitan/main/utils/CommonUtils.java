...
public class CommonUtils {
    ...
    public static void runOnUIThread(Runnable r) {
        TitanApplication.Companion.getHandler().post(r);
    }
    ...
    public static Resources getResources() {
        return TitanApplication.Companion.getInstances().getResources();
    }
    ...
    public static boolean isCameraCanUse(){
        ...
        PackageManager pm = TitanApplication.Companion.getInstances().getPackageManager();
