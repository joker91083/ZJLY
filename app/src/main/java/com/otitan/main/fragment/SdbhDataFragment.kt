...
import com.otitan.main.viewmodel.SdbhDataViewModel
...
import com.otitan.zjly.databinding.FmSdbhDataBinding
 ...
 * 湿地保护 数据管理
 */
class SdbhDataFragment : BaseFragment<FmSdbhDataBinding, SdbhDataViewModel>(), IDataBase {

    var viewmodel: SdbhDataViewModel? = null
    var picker: AddressPicker<Any>? = null

    override fun initContentView(inflater: LayoutInflater, container: ViewGroup?, savedInstanceState: Bundle?): Int {
        return R.layout.fm_sdbh_data
    }
    ...
    override fun initViewModel(): SdbhDataViewModel {
        if (viewmodel == null) {
            viewmodel = SdbhDataViewModel(activity, this)
        }
        return viewmodel as SdbhDataViewModel
    }
