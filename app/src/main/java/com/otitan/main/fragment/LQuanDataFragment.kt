...
import com.otitan.main.viewmodel.LQuanDataViewModel
...
import com.otitan.zjly.databinding.FmLquanDataBinding
 ...
 * 林权 数据管理
 */
class LQuanDataFragment : BaseFragment<FmLquanDataBinding, LQuanDataViewModel>(), IDataBase {

    var viewmodel: LQuanDataViewModel? = null
    var picker: AddressPicker<Any>? = null

    override fun initContentView(inflater: LayoutInflater, container: ViewGroup?, savedInstanceState: Bundle?): Int {
        return R.layout.fm_lquan_data
    }
    ...
    override fun initViewModel(): LQuanDataViewModel {
        if (viewmodel == null) {
            viewmodel = LQuanDataViewModel(activity, this)
        }
        return viewmodel as LQuanDataViewModel
    }
...
//                    it.onRefresh.execute()
        ...
        viewmodel?.let {
            val adapter = DataManageAdapter(context, it.items, "林权")
