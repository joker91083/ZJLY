...
import com.otitan.main.viewmodel.CfysDataViewModel
...
import com.otitan.zjly.databinding.FmCfysDataBinding
import org.jetbrains.anko.toast

/**
 * 采伐运输 数据管理
 */
class CfysDataFragment : BaseFragment<FmCfysDataBinding, CfysDataViewModel>(), IDataBase {

    var viewmodel: CfysDataViewModel? = null
    var picker: AddressPicker<Any>? = null

    override fun initContentView(inflater: LayoutInflater, container: ViewGroup?, savedInstanceState: Bundle?): Int {
        return R.layout.fm_cfys_data
    }
    ...
    override fun initViewModel(): CfysDataViewModel {
        if (viewmodel == null) {
            viewmodel = CfysDataViewModel(activity, this)
        }
        return viewmodel as CfysDataViewModel
    }
...
//                        it.onRefresh.execute()
        ...
        viewmodel?.let {
            val adapter = DataManageAdapter(context, it.items, "采伐运输")
