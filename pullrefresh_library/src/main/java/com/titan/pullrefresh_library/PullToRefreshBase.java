 ...
 *******************************************************************************/
package com.titan.pullrefresh_library;
...
import com.titan.pullrefresh_library.internal.FlipLoadingLayout;
import com.titan.pullrefresh_library.internal.LoadingLayout;
import com.titan.pullrefresh_library.internal.RotateLoadingLayout;
import com.titan.pullrefresh_library.internal.Utils;
import com.titan.pullrefresh_library.internal.ViewCompat;
...
public abstract class PullToRefreshBase<T extends View> extends LinearLayout implements IPullToRefresh<T> {
	...
	public boolean onTouchEvent(MotionEvent event) {
		...
		case MotionEvent.ACTION_MOVE: {
			float  tempY=event.getY()-actionY;
			   if(null!=onScrollToDirectListener){
				   if(tempY<0){
					   onScrollToDirectListener.onScrollToDown();
				   }else{
					   onScrollToDirectListener.onScrollToUp();
				   }
			   }
			actionY = event.getY();
			break;
	...
	public static interface OnScrollToDirectListener {
		void onScrollToUp();
