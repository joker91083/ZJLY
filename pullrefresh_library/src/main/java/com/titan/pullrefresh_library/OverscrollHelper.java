...
import com.titan.pullrefresh_library.PullToRefreshBase.State;
...
public final class OverscrollHelper {
	...
	private static final String TAG = "OverscrollHelper";
	...
	public static void overScrollBy(final PullToRefreshBase<?> view, final int deltaX, final int scrollX,
          ...
          Log.i(TAG, "fuzzyThreshold===="+fuzzyThreshold);
			...
			if (mode.permitsPullToRefresh() && !isTouchEvent && deltaValue != 0) {
				...
				if (newScrollValue < (0 - fuzzyThreshold)) {
					...
					if (mode.showHeaderLoadingLayout()) {
                        ...
                        Log.i(LOG_TAG, "currentScrollValue===="+currentScrollValue);
                        Log.i(LOG_TAG, "newScrollValue===="+newScrollValue);
					...
					if (mode.showFooterLoadingLayout()) {
						...
						if (currentScrollValue == 0) {
						  ...
						  Log.i(LOG_TAG, "scaleFactor===="+scaleFactor);
	                        Log.i(LOG_TAG, "currentScrollValue===="+currentScrollValue);
	                        Log.i(LOG_TAG, "newScrollValue===="+newScrollValue);
	                        Log.i(LOG_TAG, "newScrollValue===="+scrollRange);
